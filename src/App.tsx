...
function App() {
  return (
    <div className='h-[600px] w-full flex flex-col justify-center items-center'>
      ...
      <Link className='z-10 w-[270px] h-[60px] bg-no-repeat grayscale-100 hover:scale-110 transition text-center py-2 bg-[url(/button.svg)] -mt-6 -mr-50 font-bold font-mono' to={'/dashboard'}>
      <FuzzyText
      baseIntensity={0.1}
      enableHover={false}
      fontSize={50}
